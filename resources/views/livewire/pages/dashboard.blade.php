<div class="p-6 md:p-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Projects Card -->
        <div class="bg-white rounded-lg border border-stone-200 p-6 transition-all hover:shadow-lg hover:border-stone-300">
            <div class="flex items-start justify-between">
                <div class="space-y-1">
                    <h2 class="text-base font-medium text-stone-500 uppercase tracking-wider">Projects</h2>
                    <p class="text-5xl text-stone-900" style="font-family: 'Playfair Display', serif;">{{ $projectCount }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg border border-stone-200 p-6 transition-all hover:shadow-lg hover:border-stone-300">
            <div class="flex items-start justify-between">
                <div class="space-y-1">
                    ...
                    <p class="text-5xl text-stone-900" style="font-family: 'Playfair Display', serif;">{{ $categoryCount }}</p>
                </div>
                <div class="text-stone-300">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
        ...
        <div class="bg-white rounded-lg border border-stone-200 p-6 transition-all hover:shadow-lg hover:border-stone-300">
            <div class="flex items-start justify-between">
                <div class="space-y-1">
                    ...
                    <p class="text-5xl text-stone-900" style="font-family: 'Playfair Display', serif;">{{ $testimonialCount }}</p>
                </div>
                <div class="text-stone-300">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
