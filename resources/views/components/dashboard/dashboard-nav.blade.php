<div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden bg-stone-900">
    <!-- Sidebar -->
    <aside :class="sidebarOpen ? 'w-64' : 'w-20'"
        class="fixed inset-y-0 left-0 z-50 bg-stone-900 border-r border-stone-800 text-stone-200 transition-all duration-300 ease-in-out md:static shrink-0 w-20">

        <!-- Header -->
        <div class="flex items-center h-16 px-4 md:px-6 border-b border-stone-800 justify-center md:justify-between"
            :class="sidebarOpen ? 'justify-between' : 'justify-center md:justify-between'">

            <!-- Dashboard Text (Desktop Only) -->
            <a href="{{ url('/') }}"
            ...
            <button @click="sidebarOpen = !sidebarOpen"
                class="flex items-center justify-center w-full px-2 text-sm font-medium rounded-md group text-stone-400 hover:bg-stone-800 hover:text-white focus:outline-none"
        ...
        <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
            <a href="{{ url('/') }}"
                class="flex items-center px-2 py-2 text-sm font-medium rounded-md group hover:bg-stone-800 hover:text-white {{ request()->is('/') ? 'bg-stone-800 text-white' : 'text-stone-400' }} justify-center"
                :class="sidebarOpen ? 'justify-start' : 'justify-center'">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-5 h-5 shrink-0 mr-0 md:mr-3"
                    :class="sidebarOpen ? 'mr-3' : 'mr-0 md:mr-3'">
                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <span class="hidden" :class="sidebarOpen ? 'block' : 'hidden'">Home</span>
            </a>
            <a href="{{ url('/dashboard') }}"
                ...
                :class="sidebarOpen ? '' : 'justify-center md:justify-start'">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-5 h-5 shrink-0 mr-0 md:mr-3"
                    :class="sidebarOpen ? 'mr-3' : 'mr-0 md:mr-3'">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="px-2 mb-2 text-xs font-medium uppercase text-stone-500 hidden"
                :class="sidebarOpen ? 'block' : 'hidden'">Content</div>
            ...
            <div class="px-2 mb-2 text-xs font-medium uppercase text-stone-500"
                :class="sidebarOpen ? 'block' : 'hidden lg:block'">Profile</div>
    ...
    <div class="flex flex-col flex-1 min-w-0 overflow-hidden ml-20 md:ml-0 transition-all duration-300">
