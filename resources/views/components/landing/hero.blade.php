...
<section
    ...
    <div class="absolute inset-0 pointer-events-none z-0">
        ...
        <div class="absolute top-[-5%] left-[-5%] md:left-[5%] md:top-[10%] w-48 md:w-64 bg-stone-200 shadow-2xl -rotate-6 border-8 border-white transform transition duration-1000 hover:rotate-0 hover:scale-105 hover:z-20 opacity-30 md:opacity-100 placeholder-shimmer"
            style="aspect-ratio: {{ optional($heroImages[1])->dynamic_aspect_ratio ?? 0.75 }};">
        ...
        <div class="absolute bottom-[-5%] right-[-10%] md:right-[5%] md:bottom-[15%] w-56 md:w-80 bg-stone-200 shadow-xl rotate-3 border-8 border-white transform transition duration-1000 hover:rotate-0 hover:scale-105 hover:z-20 opacity-30 md:opacity-100"
            style="aspect-ratio: {{ optional($heroImages[2])->dynamic_aspect_ratio ?? 1.7778 }};">
        ...
        <div class="absolute top-[5%] right-[-5%] md:right-[15%] md:top-[15%] w-32 md:w-48 bg-stone-200 shadow-lg rotate-12 border-[6px] border-white transform transition duration-1000 hover:rotate-0 hover:scale-105 hover:z-20 opacity-20 md:opacity-90"
            style="aspect-ratio: {{ optional($heroImages[3])->dynamic_aspect_ratio ?? 1.0 }};">
        ...
        <div class="absolute bottom-[10%] left-[-8%] md:left-[12%] md:bottom-[10%] w-32 md:w-48 bg-stone-200 shadow-xl -rotate-12 border-[6px] border-white transform transition duration-1000 hover:rotate-0 hover:scale-105 hover:z-20 opacity-20 md:opacity-90"
            style="aspect-ratio: {{ optional($heroImages[4])->dynamic_aspect_ratio ?? 0.6667 }};">
