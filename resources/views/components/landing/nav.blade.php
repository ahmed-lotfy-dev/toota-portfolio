            ...
            <div class="hidden md:flex items-center gap-6 rtl:space-x-reverse">
                ...
                @auth
                    <form method="POST" action="{{ route('logout') }}" class="inline">
                        @csrf
                        <button type="submit" class="text-stone-400 hover:text-stone-900 transition-colors">
        ...
        <div class="px-8 py-8 space-y-6 flex flex-col items-center text-center">
            ...
            @auth
                <form method="POST" action="{{ route('logout') }}" class="w-full">
                    @csrf
                    <button type="submit" class="w-full text-sm uppercase tracking-widest text-stone-400 hover:text-stone-900 transition">
                        {{ __('Log Out') }}
                    </button>
                </form>
            @endauth
